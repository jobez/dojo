...
use dojo_test_utils::sequencer::{get_default_starknet_config, SequencerConfig, TestSequencer};
...
async fn test_migration_with_auto_mine() {
    ...
    let sequencer =
        TestSequencer::start(SequencerConfig::default(), get_default_starknet_config()).await;
